...
top_10_over_years %>%
  ...
  xlab("Year") +
  ylab("Count") +
  labs(title="Total number of articles for the top 10 headline categories for each year", subtitle = "Articles from every headline category fall below 1000 after 2014") + 
  coord_flip()
```

#### Findings

-   News and Sport categories have a lot of articles before 2014 but fell below 1000 after 2014

-   Headline categories except News And Sports always have below 1000 articles over the years

-   There are two obvious lines(sport.rugby & sport.soccer) go missing before 2006 or only exist after 2006(inclusive)
